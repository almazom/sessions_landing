...
class Task052LocalPlaywrightRealBrowserE2ETests(unittest.TestCase):
    def test_local_real_browser_e2e(self) -> None:
        fixture = build_real_session_browser_fixture()
        result = run_interactive_browser_e2e(base_url=fixture.local_base_url)
